...
training_iters = 10000                         # training step 100000
...
def mfcc_batch_generator(batch_size=10):
    ...
    while True:
        ...
        for file in files:
            ...
            mfcc = np.pad(mfcc,((0,0),(0,220-len(mfcc[0]))), mode='constant', constant_values=0)
...
def main():
    ...
    with tf.Session() as sess:
        ...
        print("Iteration # {}. Test Accuracy: {:.0f}%".format( 1, test_accuracy * 100))
